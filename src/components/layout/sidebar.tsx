...
export default function Sidebar() {
  ...
  const NavItem = ({ item }: { item: any }) => {
    ...
    return (
      <Link
        href={item.href}
        className={`group flex items-center gap-3 px-3 py-2.5 rounded-xl transition-all duration-300 text-sm font-medium relative overflow-hidden ${
          finalIsActive
      ...
      >
        ...
        <item.icon
          className={`w-[18px] h-[18px] shrink-0 transition-all duration-300 ${finalIsActive ? "text-[#4f7cff]" : "text-[#6b6b80] group-hover:text-[#a259ff]"}`}
        />
  ...
  return (
    ...
    >
      <div className="p-5 flex items-center justify-between border-b border-[#333339]">
        <div
          className={`group flex items-center gap-3 cursor-pointer hover:bg-white/5 p-2 rounded-xl w-full transition-all duration-300 border border-transparent hover:border-white/10 ${
        ...
        >
          ...
          {!isCollapsed && (
            <div className="flex-1 overflow-hidden ml-1 flex items-center justify-between">
              <div className="text-base font-bold truncate font-syne tracking-wide text-[#f0f0f5]">
                SprintFlow
              </div>
      ...
      <div className="p-5 border-t border-[#333339]">
        <div
          className={`flex items-center gap-3 cursor-pointer hover:bg-white/5 p-2 rounded-xl transition-colors border border-transparent hover:border-white/10 ${
            isCollapsed ? "justify-center" : ""
          }`}
        >
