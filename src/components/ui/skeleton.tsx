...
const pulse = "animate-pulse bg-hover-strong";
  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
      {Array.from({ length: count }).map((_, i) => (
        <div key={i} className="rounded-2xl bg-[var(--color-surface)] border border-border p-6">
    ...
    <div className="flex flex-col gap-8 pb-12">
      <div className="flex items-start justify-between gap-4">
        ...
        {settingsHref ? (
          <Link
            href={settingsHref}
            className="p-2.5 text-muted hover:text-fg bg-surface border border-border rounded-xl transition-colors shrink-0"
          >
      ...
      <section>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          {Array.from({ length: 3 }).map((_, i) => (
            <div key={i} className="rounded-2xl border border-border bg-[var(--color-surface)] p-5">
    ...
    <>
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
        {DASH_STAT_LABELS.map((label) => (
          <div
            key={label}
            className="rounded-2xl bg-[var(--color-surface)] border border-border p-5"
          >
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-4">
        <div className="rounded-2xl bg-[var(--color-surface)] border border-border p-6 space-y-6">
        ...
        <div className="lg:col-span-2 rounded-2xl bg-[var(--color-surface)] border border-border p-6">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-4">
        <div className="lg:col-span-2 rounded-2xl bg-[var(--color-surface)] border border-border overflow-hidden">
...
const TEAM_STAT_META = [
  { label: "Total Members", Icon: Users, color: "var(--color-accent)" },
  { label: "Admins", Icon: Shield, color: "var(--color-accent2)" },
  { label: "Project Managers", Icon: Briefcase, color: "var(--color-warning)" },
  { label: "Members", Icon: UserCircle, color: "var(--color-success)" },
] as const;
    ...
    <div className="flex flex-col gap-6">
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        {TEAM_STAT_META.map(({ label, Icon, color }) => (
          <div
            key={label}
            className="group relative p-5 rounded-2xl bg-[var(--color-surface)] border border-border"
          >
  ...
  return (
    <div className="space-y-4">
      {Array.from({ length: rows }).map((_, i) => (
        <div
          key={i}
          className="rounded-2xl border border-border bg-[var(--color-surface)] p-5 flex gap-4"
        >
          <Skeleton className="h-10 w-10 rounded-xl shrink-0" />
          <div className="flex-1 space-y-2">
...
export function InviteCardSkeleton() {
  return (
    <div className="flex flex-col gap-4 py-4">
      ...
      <Skeleton className="h-px w-full rounded bg-border" />
      <div className="space-y-3">
    ...
    <div className="flex flex-nowrap gap-0 px-6 py-6">
      {Array.from({ length: 4 }).map((_, col) => (
        <div key={col} className="flex shrink-0 w-[300px] flex-col px-1">
          ...
          <div className="flex-1 space-y-2 rounded-xl border border-border bg-hover p-2 min-h-[280px]">
            {Array.from({ length: col % 2 === 0 ? 3 : 2 }).map((__, row) => (
              <div key={row} className="rounded-lg border border-border bg-surface p-3.5 space-y-2">
  ...
  return (
    <div className="space-y-8">
      {Array.from({ length: 2 }).map((_, s) => (
        <div key={s} className="rounded-xl border border-border bg-surface/40 overflow-hidden">
    ...
    <div className="space-y-8">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        <div className="bg-surface border border-border rounded-xl p-6">
          <h3 className="text-[15px] font-semibold text-fg mb-6">Sprint Velocity</h3>
          <Skeleton className="h-[180px] w-full rounded-lg" />
        </div>
        <div className="bg-surface border border-border rounded-xl p-6">
          <h3 className="text-[15px] font-semibold text-fg mb-6">Recent Activity</h3>
      ...
      <aside className="w-[280px] shrink-0 border-r border-border bg-surface-sunken/40 hidden lg:flex flex-col p-6">
        <div className="mb-8">
          ...
          <nav className="space-y-1">
            <div className="w-full flex items-center gap-3 px-3 py-2.5 rounded-xl text-[13px] font-medium bg-hover-strong text-fg">
              <Settings className="w-4 h-4 text-accent" />
              General
            </div>
            <div className="w-full flex items-center gap-3 px-3 py-2.5 rounded-xl text-[13px] font-medium text-muted">
