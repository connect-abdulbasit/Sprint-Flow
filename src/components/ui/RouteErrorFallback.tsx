...
export default function RouteErrorFallback({
  ...
  return (
    <div className="flex min-h-[60vh] w-full flex-col items-center justify-center gap-4 px-6 py-16 text-center">
      <div className="flex h-14 w-14 items-center justify-center rounded-2xl border border-danger/25 bg-danger-soft">
      ...
      <div className="flex items-center gap-3 pt-2">
        <button
          type="button"
          onClick={reset}
          className="inline-flex items-center gap-2 rounded-xl bg-fg px-4 py-2.5 text-[13px] font-semibold text-bg hover:bg-fg-strong"
        >
        ...
        <Link
          href={homeHref}
          className="rounded-xl border border-border px-4 py-2.5 text-[13px] font-medium text-muted2 no-underline hover:bg-hover hover:text-fg"
        >
          Go back
        </Link>
      </div>
