            ...
            <div className="flex flex-col md:flex-row bg-[#111118] rounded-3xl shadow-2xl border border-[#333339] overflow-hidden w-full">
                ...
                <div className="flex-1 p-8 md:p-12">
                    ...
                    <form onSubmit={handleContinue} className="space-y-6">
                        ...
                        {/* Name Input */}
                        <div>
                            <label htmlFor="workspaceName" className="block text-sm font-medium text-[#f0f0f5] mb-2">
                                Workspace Name
                            </label>
                            <div
                                className={`flex items-center rounded-xl border transition-all duration-200 bg-[#18181f] ${isFocused
                            ...
                            <div className="mt-3 flex items-start gap-2 bg-[#18181f] rounded-lg p-3 border border-[#333339]">
                                ...
                                <div>
                                    ...
                                    <p className="text-sm text-[#f0f0f5] font-mono mt-0.5 break-all">
                                        {currentDomain}/<span className="text-[#4f7cff] font-semibold">{slug || 'workspace-name'}</span>
                                    </p>
                                </div>
                            </div>
                        </div>
                    ...
                    <div className="space-y-6">
                        <div>
                            <h3 className="text-sm font-bold text-[#f0f0f5] mb-2 flex items-center gap-2">
                                <span className="flex h-5 w-5 items-center justify-center rounded-full bg-[#4f7cff]/20 text-[#4f7cff] text-[10px]">1</span>
                                Create Workspaces
                            </h3>
                            <p className="text-xs text-[#9090a8] leading-relaxed">
                                Workspaces contain all your projects, boards, and team members in one isolated environment.
                            </p>
                        </div>
                        <div>
                            <h3 className="text-sm font-bold text-[#f0f0f5] mb-2 flex items-center gap-2">
                                <span className="flex h-5 w-5 items-center justify-center rounded-full bg-[#18181f] text-[#6b6b80] text-[10px]">2</span>
                                Invite Members
                            </h3>
                            <p className="text-xs text-[#9090a8] leading-relaxed">
                        ...
                        <div>
                            <h3 className="text-sm font-bold text-[#f0f0f5] mb-2 flex items-center gap-2">
                                <span className="flex h-5 w-5 items-center justify-center rounded-full bg-[#18181f] text-[#6b6b80] text-[10px]">3</span>
                                Start Sprinting
                            </h3>
                            <p className="text-xs text-[#9090a8] leading-relaxed">
